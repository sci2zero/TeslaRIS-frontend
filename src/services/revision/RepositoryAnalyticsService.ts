...
import { type DimensionQuality, type EntityTypeQuality, type IssueStatistics, type PublicationCandidateAnalysis, type RepositoryOverview } from "@/models/RevisionModel";
