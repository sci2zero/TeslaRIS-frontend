export default {
    routeLabel: {
        ...
        fundingProgramLandingPage: "Detalji programa finansiranja",
        submitFundingProgram: "Dodavanje programa finansiranja",
        projectLandingPage: "Detalji projekta",
        submitProject: "Dodavanje projekta",
        fundingPrograms: "Programi finansiranja",
        fundingCalls: "Pozivi za finansiranje",
        projects: "Projekti",
        repositoryAnalytics: "Analitika repozitorijuma",
        issueExplorer: "Pregled problema",
        policyExplorer: "Pregled politike",
        crisContextInformation: "Informacije o CRIS kontekstu"
    },
    emailLabel: "Email",
    ...
    programNameColumn: "programNameSr",
    coordinatorNameColumn: "coordinatorNameSr",
    ...
    advancedOptionsLabel: "Napredne opcije",
    tutorialOptionsLabel: "Opcije tutorijala",
    startTutorialLabel: "Pokreni tutorijal",
    resetTutorialHistoryLabel: "Resetuj istoriju tutorijala",
    tutorialHistoryResetMessage: "Istorija tutorijala je resetovana.",
    tutorial: {
        stepCounter: "Korak {current} / {total}",
        skipLabel: "Preskoči",
        continueLabel: "Dalje",
        nextLabel: "Sledeće",
        scrollUpLabel: "Skrolujte nagore",
        scrollDownLabel: "Skrolujte nadole",
        scrollLeftLabel: "Skrolujte levo",
        scrollRightLabel: "Skrolujte desno",
    },
    ...
    unauthorizedProjectEditAttemptMessage: "Ne možete dodati/izmeniti projekat u kojem niste član tima.",
    ...
    removeFromProjectLabel: "Ukloni me sa projekta",
    researcherProjectUnbindWarning: "Ovaj projekat će se ukloniti iz vaše liste projekata.",
    projectUnbindSuccessMessage: "Uspešno ste uklonjeni sa projekta.",
    removeInstitutionFromProjectLabel: "Ukloni moju instituciju sa projekta",
    institutionProjectUnbindWarning: "Istraživači vaše institucije i vaša institucija u konzorcijumu biće odvezani od ovog projekta.",
    institutionProjectUnbindSuccessMessage: "Vaša institucija je uspešno uklonjena sa projekta.",
    massProjectUnbindSuccessMessage: "Uspešno ste uklonjeni sa projekta: {name}",
    massInstitutionProjectUnbindSuccessMessage: "Uspešno ste uklonili svoju instituciju sa projekta: {name}",
    projectUnbindFailedMessage: "Uklanjanje sa projekta '{name}' nije uspelo.",
    ...
    showOnlyMyProjectsLabel: "Prikaži samo moje projekte",
    ...
    enabledModulesLabel: "Omogućeni moduli",
    enabledModulesDescriptionLabel: "Moduli koji su isključeni sakriveni su u celom sistemu.",
    crisConfigurationLabel: "Konfiguracija sistema",
    crisConfigurationDescriptionLabel: "Licenca metapodataka i formati nacionalnih identifikatora.",
    metadataLicenseLabel: "Licenca metapodataka",
    personNationalIdPatternLabel: "Format nacionalnog identifikatora osobe",
    projectNationalIdPatternLabel: "Format nacionalnog identifikatora projekta",
    organisationUnitNationalIdPatternLabel: "Format nacionalnog identifikatora institucije",
    documentNationalIdPatternLabel: "Format nacionalnog identifikatora dokumenta",
    regularExpressionHintLabel: "Regularni izraz, koristite .* da dozvolite bilo koju vrednost",
    invalidRegularExpressionError: "Ovo nije validan regularni izraz",
    ...
    registryEntryStepIncompleteMessage: "Na ovom koraku postoje nepopunjena ili neispravna polja.",
    registryEntryCannotBeSavedMessage: "Ovaj unos još uvek ne može biti sačuvan.",
    registryEntryThesisNotEligibleMessage: "Unos može biti označen kao spreman za promociju tek kada se završi uvid javnosti i unese datum odbrane.",
    registryEntryPromotionFinishedMessage: "Ovaj unos pripada završenoj promociji i ne može se menjati osim ako je za njega dozvoljena pojedinačna izmena.",
    ...
    nationalIdFormatError: "Nacionalni identifikator ne odgovara konfigurisanom formatu.",
    nationalIdExistsError: "Nacionalni identifikator je već u upotrebi.",
    nationalScienceIdFormatError: "Nacionalni identifikator nauke ne odgovara konfigurisanom formatu.",
    ...
    qualityByEntityTypeLabel: "Kvalitet po tipu entiteta",
    repositoryQualityOverviewLabel: "Pregled kvaliteta repozitorijuma",
    issuesRequiringAttentionLabel: "Problemi koji zahtevaju pažnju",
    recordsAssessedLabel: "Vrednovani entiteti",
    qualityTrendsLabel: "Trendovi kvaliteta",
    metricLabel: "Metrika",
    pointsLabel: "Tačaka",
    metricOverTimeLabel: "{0} kroz vreme",
    currentIndicatorsLabel: "Trenutni pokazatelji",
    selectedMetricLabel: "Izabrana metrika: {0}",
    trendByEntityTypeLabel: "Trend po tipu entiteta",
    scoreOrRateLabel: "Ocena / stopa (%)",
    dailyLabel: "Dnevno",
    weeklyLabel: "Nedeljno",
    monthlyLabel: "Mesečno",
    currentScoreLabel: "Trenutna ocena",
    previousScoreLabel: "Prethodna ocena",
    changeLabel: "Promena",
    bestScoreLabel: "Najbolja ocena",
    lowestScoreLabel: "Najlošija ocena",
    qualityByDimensionLabel: "Kvalitet po dimenziji",
    downloadReportLabel: "Preuzmi izveštaj",
    recordsLabel: "Ukupno entiteta",
    publicationCandidatesLabel: "Kandidati za objavljivanje",
    publicationCandidateAnalysisLabel: "Analiza kandidata za objavljivanje",
    candidateRateByEntityTypeLabel: "Postotak kandidata po tipu entiteta",
    mostCommonBlockingConstraintsLabel: "Najčešća blokirajuća ograničenja",
    notPublicationCandidatesLabel: "Nisu kandidati za objavljivanje",
    candidateRateLabel: "Postotak kandidata",
    blockingConstraintsLabel: "Blokirajuća ograničenja",
    blockingIssuesLabel: "Blokirajući problemi",
    organisationUnitsLabel: "Organizacione jedinice",
    assessmentContextLabel: "Kontekst vrednovanja",
    dataGovernanceQualityPolicyLabel: "Upravljanje podacima / Polisa kvaliteta",
    overviewLabel: "Pregled",
    trendsLabel: "Trendovi",
    entityTypesLabel: "Tipovi entiteta",
    dimensionsLabel: "Dimenzije",
    issueStatisticsLabel: "Statistika problema",
    issuesBySeverityAndEntityTypeLabel: "Problemi po ozbiljnosti i tipu entiteta",
    topRecurringConstraintsLabel: "Najčešća ograničenja",
    errorIssuesLabel: "Greška",
    warningIssuesLabel: "Upozorenje",
    infoIssuesLabel: "Informacija",
    ...
    dateAwardedLabel: "Projekat odobren za finansiranje",
    dateFromLabel: "Datum početka",
    dateSubmittedLabel: "Predlog projekta predat",
    ...
    addFundingLabel: "Dodaj finansiranje",
    ...
    createNewFundingProgramLabel: "Dodaj program finansiranja",
    createNewFundingCallLabel: "Dodaj poziv za finansiranje",
    fundingCallDateRangeMessage: "Poziv mora biti otvoren pre nego što se zatvori.",
    fundingCallOpeningBeforeProgramOpeningMessage: "Poziv ne može biti otvoren pre otvaranja programa.",
    fundingCallClosingAfterProgramClosingMessage: "Poziv ne može biti zatvoren nakon zatvaranja programa.",
    fundingCallMissingProgramOrFunderMessage: "Poziv mora biti vezan za program ili za finansijera.",
    createNewProjectLabel: "Dodaj projekat",
    projectLabel: "Projekat",
    amountRequestedLabel: "Traženi iznos",
    submitterLabel: "Podnosilac",
    submissionDateLabel: "Datum podnošenja",
    responseSummaryLabel: "Rezime odgovora",
    reviewStartedLabel: "Početak revizije",
    reviewEndedLabel: "Kraj revizije",
    dateOfDecisionLabel: "Datum odluke",
    resultLabel: "Rezultat",
    deadlineForRequestedChangesLabel: "Rok za tražene izmene",
    revisedFundingApplicationLabel: "Povezan zahtev za finansiranje",
    otherFundingSourcesLabel: "Ostali izvori finansiranja",
    updateFundingApplicationLabel: "Ažuriraj zahtev za finansiranje",
    createNewFundingApplicationLabel: "Novi zahtev za finansiranje",
    addFundingApplicationLabel: "Dodaj zahtev za finansiranje",
    ...
    addFundingProgramLabel: "Program finansiranja",
    statusLabel: "Status",
    ...
    showOnlyWithoutContributions: "Prikaži samo bez kontribucija",
    ...
    restoreInvolvementRecreatedMessage: "Angažovanje (ID {0}) više ne postoji i ponovo je kreirano, pa sada ima novi identifikator.",
    restoreInvolvementInstitutionExternalMessage: "Ustanova (ID {0}) više ne postoji, pa je angažovanje zadržano samo sa nazivom spoljne ustanove.",
    restoreHostInstitutionMissingMessage: "Ustanova domaćin (ID {0}) više ne postoji i nije postavljena.",
    restoreSupervisorMissingMessage: "Mentor (ID {0}) više ne postoji i nije postavljen.",
    restoreEmploymentPositionMissingMessage: "Radno mesto (ID {0}) više ne postoji i nije postavljeno.",
    dataQualityLabel: "Kvalitet podataka",
    relatedQualityLabel: "Kvalitet povezanih entiteta",
    dataQualityIssuesLabel: "Prikaz problema",
    recordVersionLabel: "Verzija entiteta",
    assessmentForVersionLabel: "Procena - verzija entiteta {0}",
    overallScoreLabel: "Ukupna ocena",
    fairComplianceLabel: "FAIR usklađenost",
    passedLabel: "Prošlo",
    failedLabel: "Palo",
    constraintLabel: "Ograničenje",
    noMatchingConstraintsMessage: "Nema odgovarajućih ograničenja",
    policyExplorerLabel: "Pregled politike",
    viewConstraintDetailsLabel: "Prikaži detalje ograničenja →",
    viewDimensionDetailsLabel: "Prikaži detalje dimenzije →",
    searchConstraintsLabel: "Pretraga naziva ili ključa ograničenja...",
    showingConstraintsMessage: "Prikazano {from}-{to} od {total} ograničenja",
    targetWeightLabel: "Težina cilja",
    ...
    relatedQualityExplanationMessage: "Status kvaliteta entiteta povezanih sa ovim entitetom.",
    relatedActivitiesExplanationMessage: "Broji sve procenjene aktivnosti na zapisima sa kojima je ovaj entitet povezan, uključujući i aktivnosti drugih učesnika na njima, ne samo njegove. Svako sa pravom izmene takvog zapisa može ispraviti i te probleme.",
    relatedQualityOnlyForLatestVersionMessage: "Povezani kvalitet se prikazuje samo za najnoviju verziju ovog entiteta.",
