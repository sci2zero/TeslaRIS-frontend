export default {
    routeLabel: {
        ...
        exhibitionMetadataComparator: "Exhibition Metadata Comparator",
        submitConference: "Submit Conference",
        submitExhibition: "Submit Exhibition",
        ...
        submitIntellectualProperty: "Submit intellectual property",
        submitIntangibleProduct: "Submit intangible product",
        ...
        intangibleProductLandingPage: "Intangible Product Details",
        intangibleProductMetadataComparator: "Intangible Product Metadata Comparator",
        intellectualPropertyLandingPage: "Intellectual Property Details",
        intellectualPropertyMetadataComparator: "Intellectual Property Metadata Comparator",
        ...
        geneticMaterialLandingPage: "Genetic material details",
        submitGeneticMaterial: "Submit genetic material",
        geneticMaterialMetadataComparator: "Comparing genetic material metadata",
        prizes: "Prizes",
        ...
        crisContextInformation: "CRIS context information"
    },
    emailLabel: "Email",
    ...
    coordinatorNameColumn: "coordinatorNameOther",
    ...
    tutorialOptionsLabel: "Tutorial Options",
    startTutorialLabel: "Start Tutorial",
    resetTutorialHistoryLabel: "Reset Tutorial History",
    tutorialHistoryResetMessage: "Tutorial history has been reset.",
    tutorial: {
        stepCounter: "Step {current} / {total}",
        skipLabel: "Skip",
        continueLabel: "Continue",
        nextLabel: "Next",
        scrollUpLabel: "Scroll up",
    ...
    addJournalPublicationLabel: "Journal Publication",
    volumeLabel: "Volume",
    issueLabel: "Issue",
    ...
    addIntellectualPropertyLabel: "Intellectual property",
    addIntangibleProductLabel: "Intangible product",
    intellectualPropertyNumberLabel: "Intellectual property number",
    ...
    intangibleProductLabel: "Intangible product",
    ...
    unauthorizedProjectEditAttemptMessage: "You can't submit or edit projects where you are not a team member.",
    ...
    updateIntangibleProductLabel: "Update Intangible Product",
    ...
    intellectualPropertyMetadataComparatorLabel: "Comparing intellectual property metadata",
    intangibleProductMetadataComparatorLabel: "Comparing intangible product metadata",
    ...
    removeFromProjectLabel: "Remove me from project",
    researcherProjectUnbindWarning: "This project will be removed from your projects list.",
    projectUnbindSuccessMessage: "You are successfully removed from this project.",
    removeInstitutionFromProjectLabel: "Remove my institution from project",
    institutionProjectUnbindWarning: "Researchers of your institution and your institution in the consortium will be unbound from this project.",
    institutionProjectUnbindSuccessMessage: "Your institution is successfully removed from this project.",
    massProjectUnbindSuccessMessage: "You are successfully removed from project: {name}",
    massInstitutionProjectUnbindSuccessMessage: "Your institution is successfully removed from project: {name}",
    projectUnbindFailedMessage: "Removal from project '{name}' failed.",
    ...
    showOnlyMyProjectsLabel: "Show only my projects",
    ...
    putOnPublicReviewWarningMessage: "When the thesis is placed under public review, all modifications will be disabled until the public review period ends. Start the public review?",
    putOnShortenedPublicReviewWarningMessage: "Upon the decision of the competent professional council pursuant to paragraph 8 of Article 26 of the Rules for Doctoral Studies of the University of Novi Sad, the revised or supplemented evaluation report of the doctoral dissertation or doctoral art project is again made available for public review for a period of 10 days. Start the shortened public review?",
    removeFromPublicReviewWarningMessage: "By removing the thesis from public review, modifications will be allowed, after which you will be able to start a new or continue the current public review. This operation should only be used in exceptional situations.",
    ...
    addInstitutionLibrarianLabel: "Institutional librarian",
    addHeadOfLibraryLabel: "Library administrator",
    continuePublicReviewLabel: "Continue public review",
    restartPublicReviewLabel: "Restart public review",
    restartLastReviewWarningMessage: "By restarting the public review, you invalidate the entire period spent in the current public review. Do you want to start a new public review?",
    ...
    notDefendedLabel: "Not Defended",
    closedAccessLabel: "Closed Access",
    publiclyAvailableLabel: "Open Access",
    thesisReportTitle: "Theses report",
    defendedThesesLabel: "Defended theses",
    notDefendedThesesLabel: "Not defended theses",
    publicReviewThesesLabel: "Theses put on public review",
    publiclyAvailableThesesLabel: "Open access theses",
    closedAccessThesesLabel: "Closed access theses",
    ...
    onlyOpenAccessLabel: "Only open formatccess",
    fieldLabel: "Field",
    ...
    addRegistryBookAdminLabel: "Registry book administrator",
    ...
    enabledModulesDescriptionLabel: "Modules that are switched off are hidden across the system.",
    crisConfigurationLabel: "System configuration",
    crisConfigurationDescriptionLabel: "Metadata licensing and national identifier formats.",
    metadataLicenseLabel: "Metadata license",
    personNationalIdPatternLabel: "Person national ID format",
    projectNationalIdPatternLabel: "Project national ID format",
    organisationUnitNationalIdPatternLabel: "Organisation unit national ID format",
    documentNationalIdPatternLabel: "Document national ID format",
    regularExpressionHintLabel: "Regular expression, use .* to allow any value",
    invalidRegularExpressionError: "This is not a valid regular expression",
    ...
    failedEvaluationForLabel: "Failed evaluation for",
    runtimeEvaluationLabel: "Runtime Evaluation",
    scoreLabel: "Score",
    actualValueLabel: "Actual value",
    constraintDefinitionLabel: "Constraint Definition",
    targetObjectLabel: "Target Object",
    constraintWeightLabel: "Constraint Weight",
    fairRelatedLabel: "FAIR-related",
    blockingLabel: "Blocking",
    dataGovernanceProvenanceLabel: "Data Governance Provenance",
    policyLabel: "Policy",
    policyVersionLabel: "Policy Version",
    qualityDimensionLabel: "Quality Dimension",
    dimensionDefinitionLabel: "Dimension Definition",
    openLandingPageLabel: "Open landing page",
    ...
    showNonArchivedLabel: "Show only non formatrchived",
    ...
    updateResearchSubAreasLabel: "Update research sub formatreas",
    selectSubAreasLabel: "Choose research sub formatreas:",
    ...
    showOnlyWithoutContributionsLabel: "Show only those without contributions",
    showProceedingsOnlyLabel: "Show only proceedings",
    emptyProceedingsOnlyLabel: "Show only empty proceedings",
    noContributionsProceedingsOnlyLabel: "Show only proceedings without contributions",
    ...
    addGeneticMaterialLabel: "Genetic material",
    ...
    prizeLabel: "Prize",
    createNewExhibitionLabel: "Add exhibition",
    exhibitionAbbreviationLabel: "Exhibition name abbreviation",
    exhibitionNumberLabel: "Exhibition Number",
    ...
    biographyVisibleLabel: "Biography visible to unauthenticated users",
    ...
    registryEntryStepIncompleteMessage: "This step has missing or invalid fields.",
    registryEntryCannotBeSavedMessage: "This entry cannot be saved yet.",
    registryEntryThesisNotEligibleMessage: "The entry can be marked ready for promotion only once the public review is completed and a defence date is recorded.",
    registryEntryPromotionFinishedMessage: "This entry belongs to a finished promotion and cannot be changed unless a single edit is allowed for it.",
    ...
    nationalIdFormatError: "National identifier does not match the configured format.",
    nationalIdExistsError: "National identifier already in use.",
    nationalScienceIdFormatError: "National science identifier does not match the configured format.",
    ...
    invalidRorMessage: "Wrong Lattes ID format.",
    invalidRinggoldMessage: "Wrong Ringgold ID format.",
    invalidFundrefMessage: "Wrong FundRef ID format.",
    invalidIsniMessage: "Wrong ISNI format.",
    invalidFctIdMessage: "Wrong FCT ID format.",
    invalidTaxNumberMessage: "Wrong tax number format.",
    ...
    associatedEditorsLabel: "Associated editors",
    ...
    dataQualitySummaryTitleLabel: "Data quality assessment summary",
    publicationCandidateLabel: "Publication candidate",
    needsRevisionLabel: "Needs revision",
    failedConstraintsLabel: "failed constraints",
    assessmentDateLabel: "Assessment date",
    revisionHistoryLabel: "Revision history",
    statusLabel: "Status",
    qualityProfileLabel: "Quality profile",
    qualityByEntityTypeLabel: "Quality by Entity Type",
    repositoryQualityOverviewLabel: "Repository Quality Overview",
    issuesRequiringAttentionLabel: "Issues requiring attention",
    recordsAssessedLabel: "Records assessed",
    qualityTrendsLabel: "Quality Trends",
    metricLabel: "Metric",
    pointsLabel: "Points",
    metricOverTimeLabel: "{0} over time",
    currentIndicatorsLabel: "Current indicators",
    selectedMetricLabel: "Selected metric: {0}",
    trendByEntityTypeLabel: "Trend by entity type",
    scoreOrRateLabel: "Score / rate (%)",
    dailyLabel: "Daily",
    weeklyLabel: "Weekly",
    ...
    qualityByDimensionLabel: "Quality by Dimension",
    downloadReportLabel: "Download report",
    recordsLabel: "Total entities",
    publicationCandidatesLabel: "Publication candidates",
    publicationCandidateAnalysisLabel: "Publication Candidate Analysis",
    candidateRateByEntityTypeLabel: "Candidate rate by entity type",
    mostCommonBlockingConstraintsLabel: "Most common blocking constraints",
    notPublicationCandidatesLabel: "Not publication candidates",
    candidateRateLabel: "Candidate rate",
    blockingConstraintsLabel: "Blocking constraints",
    blockingIssuesLabel: "Blocking issues",
    organisationUnitsLabel: "Organisation Units",
    assessmentContextLabel: "Assessment context",
    dataGovernanceQualityPolicyLabel: "Data Governance / Quality Policy",
    overviewLabel: "Overview",
    trendsLabel: "Trends",
    entityTypesLabel: "Entity Types",
    dimensionsLabel: "Dimensions",
    issueStatisticsLabel: "Issue Statistics",
    issuesBySeverityAndEntityTypeLabel: "Issues by severity and entity type",
    topRecurringConstraintsLabel: "Top recurring constraints",
    errorIssuesLabel: "Error",
    warningIssuesLabel: "Warning",
    infoIssuesLabel: "Info",
    totalAssessmentsLabel: "{count} total",
    ...
    detailedAssessmentLabel: "Detailed assessment",
    restoreRevisionLabel: "Restore",
    ...
    fundingTypesLabel: "Funding types",
    dateAwardedLabel: "Awarded on",
    dateFromLabel: "Start date",
    dateSubmittedLabel: "Submitted on",
    amountLabel: "Amount",
    urisLabel: "URIs",
    oaMandatedLabel: "OA Mandated",
    oaMandateUrlLabel: "OA Mandate URL",
    competitiveLabel: "Is competitive",
    renewableLabel: "Is renewable",
    internalInvestmentLabel: "Is internal investment",
    fundingPartsLabel: "Funding parts",
    agreementsLabel: "Agreements",
    addFundingLabel: "Add Funding",
    ...
    createNewFundingProgramLabel: "Add funding program",
    createNewFundingCallLabel: "Add funding call",
    fundingCallDateRangeMessage: "The call must open before it closes.",
    fundingCallOpeningBeforeProgramOpeningMessage: "The call cannot open before the programme opens.",
    fundingCallClosingAfterProgramClosingMessage: "The call cannot close after the programme closes.",
    fundingCallMissingProgramOrFunderMessage: "The call must be bound to a funding programme or a funder.",
    createNewProjectLabel: "Add project",
    ...
    reviewStartedLabel: "Review started",
    reviewEndedLabel: "Review ended",
    dateOfDecisionLabel: "Date of decision",
    resultLabel: "Result",
    deadlineForRequestedChangesLabel: "Deadline for requested changes",
    revisedFundingApplicationLabel: "Linked funding application",
    otherFundingSourcesLabel: "Other funding sources",
    updateFundingApplicationLabel: "Update funding application",
    createNewFundingApplicationLabel: "New funding application",
    addFundingApplicationLabel: "Add funding application",
    ...
    showOnlyWithoutContributions: "Show only without contributions",
    ...
    restoreInvolvementRecreatedMessage: "Involvement (ID {0}) no longer exists and was recreated, so it now has a new identifier.",
    restoreInvolvementInstitutionExternalMessage: "Institution (ID {0}) no longer exists, so the involvement was kept with its external institution name only.",
    restoreHostInstitutionMissingMessage: "Host institution (ID {0}) no longer exists and was not set.",
    restoreSupervisorMissingMessage: "Supervisor (ID {0}) no longer exists and was not set.",
    restoreEmploymentPositionMissingMessage: "Employment position (ID {0}) no longer exists and was not set.",
    dataQualityLabel: "Data quality",
    relatedQualityLabel: "Related entities quality",
    dataQualityIssuesLabel: "Data quality issues",
    recordVersionLabel: "Record version",
    assessmentForVersionLabel: "Assessment - record version {0}",
    overallScoreLabel: "Overall score",
    fairComplianceLabel: "FAIR compliance",
    passedLabel: "Passed",
    failedLabel: "Failed",
    constraintLabel: "Constraint",
    noMatchingConstraintsMessage: "No matching constraints",
    policyExplorerLabel: "Policy explorer",
    viewConstraintDetailsLabel: "View constraint details →",
    viewDimensionDetailsLabel: "View dimension details →",
    searchConstraintsLabel: "Search constraint title or key...",
    showingConstraintsMessage: "Showing {from}-{to} of {total} constraints",
    ...
    relatedActivitiesExplanationMessage: "Counts every assessed activity on the records this entity is linked to, including other contributors' activities on them, not only its own. Anyone with edit rights on such a record can fix those issues as well.",
