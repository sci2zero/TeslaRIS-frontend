...
export default defineComponent({
    ...
    components: { AttachmentList, PersonDocumentContributionTabs, KeywordList, DescriptionSection, LocalizedLink, JournalPublicationUpdateModal, UriList, IdentifierLink },
    setup() {
