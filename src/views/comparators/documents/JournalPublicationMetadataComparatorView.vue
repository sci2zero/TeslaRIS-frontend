        ...
        <v-row class="d-flex flex-row justify-center align-start">
            <v-col cols="5">
                ...
                <journal-publication-update-form
                    ref="updateLeftRef"
                    :preset-journal-publication="leftJournalPublication"
                    in-comparator
                    :in-modal="false"
                    @update="updateLeft"
                />
                ...
                <description-or-biography-update-form
                    ...
                    :preset-description-or-biography="(leftJournalPublication?.description as MultilingualContent[])"
                    @update="updateLeftDescription"
                />

                <keyword-update-form
                    ref="updateLeftKeywordsRef"
                    :preset-keywords="(leftJournalPublication?.keywords as MultilingualContent[])"
                ...
                <attachment-section
                    :document="leftJournalPublication"
                    :proofs="leftJournalPublication?.proofs"
                    :file-items="leftJournalPublication?.fileItems"
                    in-comparator
                />
            </v-col>
            ...
            <v-col cols="5">
                ...
                <journal-publication-update-form
                    ref="updateRightRef"
                    :preset-journal-publication="rightJournalPublication"
                    in-comparator
                    :in-modal="false"
                    @update="updateRight"
                />
                ...
                <description-or-biography-update-form
                    ...
                    :preset-description-or-biography="(rightJournalPublication?.description as MultilingualContent[])"
                    @update="updateRightDescription"
                />

                <keyword-update-form
                    ref="updateRightKeywordsRef"
                    :preset-keywords="(rightJournalPublication?.keywords as MultilingualContent[])"
                    @update="updateRightKeywords"
                />
                ...
                <attachment-section
                    :document="rightJournalPublication"
                    :proofs="rightJournalPublication?.proofs"
                    :file-items="rightJournalPublication?.fileItems"
                    in-comparator
                />
            </v-col>
        </v-row>
...
export default defineComponent({
    ...
    setup() {
        ...
        onMounted(() => {
            document.title = i18n.t("routeLabel.journalPublicationMetadataComparator");
            fetchJournals();
        });
