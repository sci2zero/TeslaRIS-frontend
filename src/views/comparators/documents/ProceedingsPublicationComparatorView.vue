    ...
    <v-container id="proceedingsPublication-publications-comparator">
        <v-row class="d-flex flex-row justify-center align-start">
            <v-col cols="5">
                ...
                <attachment-section
                    :document="leftProceedingsPublication"
                    :proofs="leftProceedingsPublication?.proofs"
                    :file-items="leftProceedingsPublication?.fileItems"
                    in-comparator
                />
            </v-col>
            ...
            <v-col cols="5">
                ...
                <attachment-section
                    :document="rightProceedingsPublication"
                    :proofs="rightProceedingsPublication?.proofs"
                    :file-items="rightProceedingsPublication?.fileItems"
                    in-comparator
                />
            </v-col>
        </v-row>
...
export default defineComponent({
    ...
    setup() {
        ...
        onMounted(() => {
            document.title = i18n.t("routeLabel.proceedingsPublicationMetadataComparator");
            fetchProceedingss();
        });
