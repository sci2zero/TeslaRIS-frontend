        ...
        <div class="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <div class="bg-white rounded-xl p-6 shadow-md border border-slate-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-blue-400/20">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h5 class="text-lg font-semibold text-slate-800 m-0">Deduplikacija</h5>
                </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-md border border-slate-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-blue-400/20">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h5 class="text-lg font-semibold text-slate-800 m-0">Vizualizacija</h5>
                </div>
                <p class="text-slate-500 leading-relaxed m-0 text-base">
            ...
            <div class="bg-white rounded-xl p-6 shadow-md border border-slate-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-blue-400/20">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h5 class="text-lg font-semibold text-slate-800 m-0">Metadata standardizacija</h5>
                </div>
                <p class="text-slate-500 leading-relaxed m-0 text-base">
