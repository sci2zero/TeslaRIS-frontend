...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const numberOfCredits = ref("");
        const academicYear = ref("");
        const groupName = ref<any[]>([]);
        const numberOfStudents = ref<number>();
        ...
        const submit = (stayOnPage: boolean) => {
            ...
            EventService.createCourse(newCourse).then((response) => {
                if (props.inModal) {
                ...
                if (stayOnPage) {
                    ...
                    academicYear.value = "";
                    numberOfStudents.value = undefined;
                    dateFrom.value = null;
                    dateTo.value = null;
                    ...
                    router.push({ name: "courseLandingPage", params: {id: response.data.id} });
                }
            }).catch(() => {
                error.value = true;
                snackbar.value = true;
        ...
        return {
            ...
            name, nameAbbreviation, description, keywords, academicYear,
            dateFrom, dateTo, eventYear, countries, selectedCountry,
            place, courseLevel, courseCode, numberOfCredits, serialEvent,
            ...
            uris, urisRef, canAddSerialEvents, dateRangeError, numberOfStudents,
