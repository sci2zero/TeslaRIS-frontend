<template>
    <div class="flex justify-between mb-2">
        <div class="flex items-center gap-2">
            <div v-if="isAdmin && selectedFundingPrograms.length > 0" class="action-menu-container">
                <v-menu offset-y>
                    <template #activator="{ props }">
                        ...
                        >
                            {{ $t("actions") }} ({{ selectedFundingPrograms.length }})
                        </v-btn>
                    </template>
            ...
            <div :class="[selectedFundingPrograms.length > 0 ? 'w-[19.25rem]' : 'w-[28rem]']">
                <slot name="top-left" />
            </div>
        </div>
        <div class="flex items-center gap-2">
