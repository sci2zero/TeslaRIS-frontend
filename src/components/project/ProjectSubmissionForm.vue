...
import { ProjectCollaborationType, ProjectResearchType, ProjectStatus, type Project, type PrepopulatedProjectMetadata, type ProjectsRelation, type PersonProjectContribution } from '@/models/ProjectModel';
