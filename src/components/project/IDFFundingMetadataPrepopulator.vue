...
import FundingMetadataPrepopulationService from '@/services/project/FundingMetadataPrepopulationService';
...
const emit = defineEmits<{
    (e: 'metadataFetched', metadata: PrepopulatedFundingMetadata): void;
...
watch(doi, async () => {
    ...
    try {
        const response = await FundingMetadataPrepopulationService.fetchFundingDataForDoi(doi.value);
